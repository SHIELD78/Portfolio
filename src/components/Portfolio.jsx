...
export default function Portfolio() {
  ...
  return (
    <div className="min-h-screen bg-black text-green-400 relative overflow-hidden">
      ...
      {/* Hero Section */}
      <section id="home" className="min-h-screen flex items-center px-4 sm:px-6 lg:px-8 pt-20">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <div className="space-y-2">
                ...
                <h1 className="text-6xl lg:text-8xl font-bold text-white mb-4 hover:animate-pulse">Hello</h1>
              ...
              <div className="flex space-x-6">
                {[
                  { icon: Github, href: "https://github.com/SHIELD78", color: "hover:text-white" },
                  {
                    icon: Linkedin,
                    href: "https://www.linkedin.com/in/ritik-roushan-rana-b6a89528a/",
                    color: "hover:text-blue-400",
                  },
                  { icon: Mail, href: "mailto:ritikrana8596@gmail.com", color: "hover:text-green-400" },
                ].map((social, index) => (
                  <a
                    key={index}
                    href={social.href}
      ...
      <section id="skills" className="py-20 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-400 font-mono">Technologies and tools I work with</p>
          </div>
            ...
            {skillGroups.map((skillGroup, index) => (
              ...
              >
                <div className="bg-gray-900/50 backdrop-blur-sm border border-gray-700 rounded-lg p-6 h-full hover:border-cyan-500/50 transition-all duration-300">
                  ...
                  <h3 className="text-lg font-semibold text-white mb-4 font-mono">{skillGroup.category}</h3>
                  <div className="space-y-2">
      ...
      <section id="experience" className="py-20 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-400 font-mono">My professional and academic background</p>
          </div>
            ...
            {experiences.map((item, index) => (
              ...
              >
                <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-3">
                  ...
                  <Badge variant="outline" className="border-gray-600 text-gray-300 bg-gray-800/50 font-mono w-fit">
                    {item.period}
                  </Badge>
                </div>
                <p className="text-cyan-400 font-medium mb-2 font-mono">{item.organization}</p>
                <p className="text-gray-400 font-mono text-sm leading-relaxed">{item.description}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section id="contact" className="py-20 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="bg-gradient-to-r from-gray-900 to-gray-800 rounded-2xl p-12 border border-cyan-500/30 hover:border-cyan-500/50 transition-all duration-300">
            <h2 className="text-4xl font-bold text-white mb-4 font-mono">
              <span className="text-cyan-400">&gt;</span> Let's Connect & Collaborate
            </h2>
            <p className="text-xl text-gray-400 mb-8 max-w-2xl mx-auto font-mono">
              Ready to discuss projects, opportunities, or just connect? Let's build something amazing together.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button
                ...
                onClick={() => window.open("mailto:ritikrana8596@gmail.com", "_self")}
              >
              ...
              <Button
                size="lg"
                variant="outline"
                className="border-cyan-500 text-cyan-400 hover:bg-cyan-500/10 font-mono bg-transparent hover:scale-105 transition-transform"
              >
      ...
      <footer className="bg-gray-900 border-t border-gray-800 py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <p className="text-gray-400 font-mono">
            &copy; 2024 Ritik Roushan Rana. Building the future, one line of code at a time.
          </p>
        </div>
      </footer>
    </div>
